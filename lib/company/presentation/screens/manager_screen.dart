...
class ManagerScreen extends StatefulWidget {
  ...
  const ManagerScreen({Key? key, required this.managerParameter}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    List<CustomCard> cards = [
      CustomCard(
        ...
        function: () {
          BlocProvider.of<OrderCubit>(context).getOrders(
              field: 'orderStatus', value: AppString.orderScreenStrings['new']!);
      ...
      CustomCard(
        ...
        function: () {
          BlocProvider.of<OrderCubit>(context).getOrders(
              field: 'orderStatus', value: AppString.orderScreenStrings['checked']!);
          GoRouter.of(context).push(AppRouter.kOrderListViewScreen, extra: {
            'manager': managerParameter['user'],
            'position': AppString.mainStrings['manager'],
      ...
      CustomCard(
        ...
        function: () {
          BlocProvider.of<OrderCubit>(context).getOrders(
              field: 'orderStatus', value: AppString.orderScreenStrings['checkout']!);
          GoRouter.of(context).push(AppRouter.kOrderListViewScreen, extra: {
            'manager': managerParameter['user'],
            'position': AppString.mainStrings['manager'],
...
class ManagerShowEmployeesScreenBody extends StatelessWidget {
  final Map<String, dynamic> managerParameter;
  const ManagerShowEmployeesScreenBody({Key? key, required this.managerParameter})
      : super(key: key);
